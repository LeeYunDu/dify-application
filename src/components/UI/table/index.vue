    ...
    >
      <template v-for="(tableProps, index) in columnsData" :key="index">
        ...
        >
          ...
          <template #[String(tableProps.headerSlot)]="tableColumnProps">
            <slot :name="tableProps.headerSlot" v-bind="tableProps">
            </slot>
          </template>
          <template #expand="tableColumnProps">
            <slot name="expand" v-bind="tableColumnProps"></slot>
          </template>
        </TableColumn>
      </template>
