    ...
    <section class="page-main">
      <div class="table-box">
        ...
        >
          ...
          <template #dialogAction="{$row,config}">
            <template v-for="btn in dialogButtons" :key="btn.key">
              <span
                class="action-btn"
                type="text"
...
import TableDialog from './components/table-dialog.vue'
...
const dialogButtons = ref([
  { label:'简单版弹窗',key:'simpleDialog' },
  { label:'表单弹窗',key:'formDialog' },
  { label:'列表弹窗',key:'tableDialog' },
])
