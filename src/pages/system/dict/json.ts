...
export const tableColumn: FieldItem[] = [
  ...
  { label: '字典名称', key: 'dictName', width: '300px' },
  { label: '字典类型', key: 'dictType', },
...
export const addDictChildFormFields = [
  ...
  {
    label: '字典项名称', key: 'dictLabel', type: 'input',
    props: {
      gridItem: { span: 24 },
      formItem: { required: true },
      clearable: true,
  ...
  {
    label: '字典项键值', key: 'dictValue', type: 'input',
    props: {
      gridItem: { span: 24 },
      formItem: { required: true },
      clearable: true,
  ...
  {
    label: '排序', key: 'dictSort', type: 'input',
    props: {
      gridItem: { span: 24 },
      formItem: { required: true },
      type: 'number',
